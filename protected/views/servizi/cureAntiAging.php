...
<h4>Ambulatorio di medicina naturale: neuralterapia, omeopatia, agopuntura</h4>
<p>
    Trattamento dei disturbi di tipo funzionale quali:
</p>
<ul>
    <li>dolori di diversa origine, cefalea cronica, emicranie, nevralgie</li>
    <li>tutte le forme reumatiche, artritiche e artrosiche (cervicale), lombaggini, sciatalgie e infiammazioni articolari,
        comprese quelle traumatiche e sportive</li>
    <li>manifestazioni cutanee, psoriasi, eczemi allergici, rinite allergica, asma</li>
    <li>Trattamento viso con gel omoterapici di ultima generazione.</li>
</ul>
